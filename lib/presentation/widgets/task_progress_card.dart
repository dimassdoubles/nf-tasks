...
class TaskProgressCard extends StatelessWidget {
  String type;
  TaskProgressCard({Key? key, required this.type}) : super(key: key);
    ...
    return Container(
      ...
      child: BlocBuilder(
        ...
        builder: (context, state) {
          ...
          List<Task> typeListTask =
              listTask.where((element) => element.type == type).toList();
          ...
          return Column(
            ...
            children: [
              Text(
                '${type[0].toUpperCase() + type.substring(1)} Progress',
